...
class Player:
    def won(self):
        ...
        return self.choosenFields in [[1, 2, 3], [4, 5, 6], [7, 8, 9], [1, 4, 7], [2, 5, 8], [3, 6, 9], [1, 5, 9],
                                      [3, 5, 7]]
...
def get_names():
    print(f'Hello :) What is the name of Player 1?')
    name = input()
    global player1
    player1 = Player(name)
    print(f'Hello :) What is the name of Player 2?')
    name = input()
    global player2
    player2 = Player(name)
...
def game_over():
    chosen_numbers.sort()
    return chosen_numbers == [1, 2, 3, 4, 5, 6, 7, 8, 9]
